[![Java CI with Maven](https://github.com/sgyldenkvist/hello-maven-ci/actions/workflows/ci.yml/badge.svg)](https://github.com/sgyldenkvist/hello-maven-ci/actions/workflows/ci.yml)
# Hello Maven CI
